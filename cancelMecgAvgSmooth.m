function [fecgSignal, mecgSignal, delay] = cancelMecgAvgSmooth(ecgSignal, fs, templateSize, windowTime, debugFlag, plotFlag)
...
%
% I. Fill the data matrix to determine the average for the first templateSize/2 
% sub-complexes. This is done by simply using the first templateSize+1 sub-complexes, 
% since they are the first entries.
...
% II. Averaging for the (templateSize/2, Rpeaks-templateSize/2) sub-complexes
...
% III. Averaging for the last templateSize/2 sub-complexes
...
% Maternal estimation and smoothing
for i=1:Rpeaks
    for j=1:samplesPer
