function [fecgSignal, mecgSignal, delay] = cancelMecg(ecgSignal, fs, templateSize, debugFlag, plotFlag)
...
[qrs_amp_raw,qrs_i_raw,~] = pan_tompkin(ecgSignal,fs,0); % find R-peak locations
